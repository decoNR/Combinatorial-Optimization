...
\begin{solution}
    ...
    Using the same ideia, it is easy to see that if $x_{rw} \neq -b_w$ for an arbitrary $x \in X$, then excess$_{x_{\text{ans}}}(w) \neq b_w$. Similarly, if $x_{ys} \neq b_y$, then excess$_{x_{\text{ans}}}(y) \neq b_y$. Since $x < u_{\text{aux}}$, we only have to check if the value of the entry of $x$ is smaller than the associated entry of $b$. It is important mentioning again that if $b_v = 0$, then excess$_{x_{\text{ans}}}(v) = 0 = b_v$. This is the case where the algorithm returns (infeasible, $V \setminus R$). 

    First, the set $S \coloneqq V \setminus R$ is clearly a subset of $V$ such that $\deltain[D](S) = \deltaout[D](R)$. Finally, I should prove that $b(S) > u(\deltain[D](S))$. Let $S' \coloneqq S \cup \{s\}$, we have that $u(\deltain[D](S)) = u_{\text{aux}}(\deltain[D_{\text{aux}}](S')) - u_{\text{aux}}(\{w \in W: \{w\} \cap S \neq \emptyset\}) - u_{\text{aux}}(\{y \in Y: \{y\} \cap R \neq \emptyset\})$. Expanding the expression, we have that $u(\deltain[D](S)) = u_{\text{aux}}(\deltain[D_{\text{aux}}](S')) - (-b(W \cap S)) - b(Y \cap (R \setminus \{r\}))$. Moreover, we have that $u(\deltain[D](S)) = u_{\text{aux}}(\deltain[D_{\text{aux}}](S')) + b(W \cap S) - (b(Y \cap V) - b(Y \cap S))$. Reorganizing the expression and using that $b(S) = b(W \cap S) + b(Y \cap S)$, we have that $u(\deltain[D](S)) = u_{\text{aux}}(\deltain[D_{\text{aux}}](S')) + b(S) - b(Y)$. In this scenario, it is straightforward that $u_{\text{aux}}(\deltain[D_{\text{aux}}](S')) < u_{\text{aux}}(\deltaout[D_{\text{aux}}](\{r\})) = -b(W) = b(Y)$. By that, we conclude that $u(\deltain[D](S)) < b(S)$, which is exactly what we want. Thus $V \setminus R$ is a certificate of the infeasibility.
